...
namespace D2L.CodeStyle.Analyzers.ServiceLocator {
	...
	public sealed class OldAndBrokenServiceLocatorAnalyzer : DiagnosticAnalyzer {
		...
		private static readonly ImmutableHashSet<string> WhitelistedAssemblies = new HashSet<string> {
			...
			"D2L.LE.Grades",
			"D2L.LE.Grades.Tests",
			"D2L.Lms.Grades.Tests",
			"D2L.Lms.Grades.Implementation",
			"D2L.Lms.Grades.Webpages",
			"D2L.LE.Groups.TestFramework",
			"D2L.Lms.Conversion.CopyCourseBulk",
			"BulkCourseCreate",
			"BulkCourseExport",
			"D2L.LE.Conversion.ClientDataConverters.BB",
			"D2L.BulkCourse.Core.IntegrationTests",
			"D2L.LE.Conversion",
			"D2L.LE.Conversion.Tests",
			"D2L.LE.CopyCourse",
			"D2L.LE.CopyCourse.IntegrationTests",
			"D2L.LE.Import.Tests",
			...
			"D2L.LE.Lti.IntegrationTests",
			"D2L.LE.ManageCourses.IntegrationTests",
			"D2L.LE.News",
			"D2L.LE.News.Tests",
			"D2L.LE.Pager.Tests.Integration",
			"D2L.LE.Pager.Webpages",
			"D2L.LE.QuestionCollection",
			"D2L.Lms.Question.Tests",
			"D2L.Lms.QuestionCollection.IntegrationTests",
			...
			"D2L.LE.Schedule",
			"D2L.LE.Schedule.LoadTests",
			"D2L.LE.Schedule.Unit.Tests",
			"D2L.LE.Scorm",
			"D2L.LE.Scorm.Tests",
			...
			"D2L.LE.UserProgress.Integration.Tests",
			...
			"D2L.Core.Workflow",
			"D2L.IntegrationTests",
			"D2L.LP",
			"D2L.LP.Diagnostics.Tracing",
			"D2L.LP.IntegrationTests",
			"D2L.LP.TestFramework",
			"D2L.Core.Users",
			"D2L.Core.JobManagement",
			"D2L.LP.Tools.DataPurgeArchive.TestFramework",
			...
			"D2L.Nitro.Core.IntegrationTests",
			"D2L.Nitro.Services.Course.IntegrationTests",
			"D2L.Nitro.Services.User.IntegrationTests",
			"D2L.Nitro.Web.IntegrationTests",
			"D2L.IM.Office365",
