...
namespace D2L.CodeStyle.Analyzers {
	public static class Diagnostics {
		...
		public static readonly DiagnosticDescriptor TooManyUnnamedArgs = new DiagnosticDescriptor(
			id: "D2L0032",
			title: "There are more than 7 unnamed arguments. Use named arguments for readability.",
			messageFormat: "There are more than 7 unnamed arguments. Use named arguments for readability.",
